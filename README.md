...
متا> [!NOTE]
> متأسفانه این پروژه دیگر در سایت در دسترس نیست.
> برای مشاهده اسکرین‌شات‌ها، به پوشه `screen-shots` مراجعه کنید یا پروژه را clone کنید.
...
اسکرین شات های بخش های دیگر درون دایرکتوری screen-shots قرار دارد. همچنین میتوانید پروژه را clone کنید و index.htlml را باز کنید.
